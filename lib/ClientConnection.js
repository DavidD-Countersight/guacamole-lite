...
class ClientConnection {
    ...
    constructor(server, connectionId, webSocket) {
        ...
        this.log(this.server.LOGLEVEL.VERBOSE,`New connection initiated on ${this.webSocket.url} or upgraded ${this.webSocket.upgradeReq.url}`);
        this.query = Url.parse(this.webSocket.upgradeReq.url, true).query;
        this.log(this.server.LOGLEVEL.VERBOSE,`Query parsed as ${this.query}`);
        this.lastActivity = Date.now();
        this.activityCheckInterval = null;

        this.log(this.server.LOGLEVEL.VERBOSE, 'Client connection open');
        this.log(this.server.LOGLEVEL.VERBOSE,`Client connection`);
