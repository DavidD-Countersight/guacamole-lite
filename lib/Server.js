...
class Server extends EventEmitter {
    ...
    newConnection(webSocketConnection, req) {
        ...
        this.activeConnections.set(this.connectionsCount, new ClientConnection(this, this.connectionsCount, webSocketConnection. req.query));
    }
}
